...
public class Lighting {
    ...
    public void draw(Graphics2D g2) {
        ...
        if (gp.keyH.checkDrawTime){
            ...
            switch(dayState) {
                case day: situation = "Jour"; break;
                case dusk: situation = "Crépuscule"; break;
                case night: situation = "Nuit"; break;
                case dawn: situation = "Aube"; break;
            }
            g2.setColor(Color.white);
            g2.setFont(g2.getFont().deriveFont(50f));
            g2.drawString(situation, 700, 500);
        }
    }
}
