...
public class Entity {
    ...
    public void facePlayer() {
            ...
            default:
                throw new IllegalStateException("Unexpected value: " + gp.player.direction);
        }
    }
    ...
    public String getOppositeDirection(String direction) {
        ...
        switch(direction) {
            case "up":getOppositeDirection = "down"; break; 
            case "down": getOppositeDirection = "up"; break; 
            case "left": getOppositeDirection = "right"; break; 
            case "right": getOppositeDirection = "left"; break; 
        }
    ...
    public void attacking() {
        ...
        if(spriteCounter > motion1_duration && spriteCounter <= motion2_duration){
            ...
            // SAVE THE CURRENT WORLD SOLIDAREA
    ...
    public void searchPath(int goalCol, int goalRow, boolean stop) {
